export type EntityType = 'catalog' | 'control' | 'profile' | 'system-security-plan' | 'assessment-plan' | 
  'assessment-results' | 'plan-of-action-and-milestones' | 'component-definition' | 'system-component' | 
  'inventory-item' | 'system-user' | 'assessment-subject' | 'task' | 'observation' | 'finding' | 
  'risk' | 'poam-item' | 'control-implementation' | 'responsible-party' | 'responsible-role' | 
  'party' | 'role' | 'system' | 'risk-management-strategy' | 'risk-assessment' | 'control-baseline' | 
  'common-control' | 'security-objective'|'security-impact-level';

  export type RootElementType = 'catalog' |'profile' | 'system-security-plan' | 'assessment-plan' | 
  'assessment-results' | 'plan-of-action-and-milestones' | 'component-definition' | 'system-component' 
 export const RootElementTypes = ['catalog' ,'profile' , 'system-security-plan' , 'assessment-plan' , 
  'assessment-results' , 'plan-of-action-and-milestones' , 'component-definition' , 'system-component']
  export type SingleElementType = "security-impact-level" ;
